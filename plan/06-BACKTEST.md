...
**Read 03-MODEL-ARCHITECTURE.md** for baseline architecture stubs.
**Read 05-TRAINING-PROCEDURE.md** for checkpoint format.
...
- `src/nanogld/model/` — doc 03 (you USE the model classes for baselines, don't modify)
...
8. **nanoGLD (Stage 3: tiny RL sizer, see doc 08)** — only if Stage 2 leaves room
