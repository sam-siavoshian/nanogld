...
def test_write_report_full(tmp_path: Path) -> None:
    ...
    perm = {
        ...
        "delta_sharpe_mean": np.array(
            [0.1, 0.05, 0.04, 0.03, 0.02, 0.01, 0.005, 0.001], dtype=np.float32
        ),
    ...
    attention = {
        ...
        "mean_present_slot": np.array(
            [0.6, 0.15, 0.1, 0.05, 0.04, 0.03, 0.02, 0.01], dtype=np.float32
        ),
        "mean_absent_slot": np.array(
            [0.95, 0.01, 0.01, 0.01, 0.01, 0.005, 0.005, 0.0], dtype=np.float32
        ),
