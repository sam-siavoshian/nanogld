# nanoGLD V1 Backtest Report — run b171dabe

- git_sha: `v4-fold0-bl3-h5ffill`
- host: `spark-0ef7`
- platform: `linux/aarch64`
- python: `3.12.3`
- torch: `2.11.0+cu130`
- started: `2026-05-25T22:19:26.234438+00:00`
- folds: 1
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | S=-0.863, DSR=-2.528 | S=0.859, DSR=-0.806 | S=-0.233, DSR=-1.898 | S=-0.455, DSR=-2.119 | S=-1.807, DSR=-3.472 | S=-2.811, DSR=-4.476 | S=0.000, DSR=-1.665 | S=0.000, DSR=-1.665 | S=0.000, DSR=-1.665 | S=0.000, DSR=-1.665 | S=0.000, DSR=-1.665 | S=-1.008, DSR=-2.672 |
